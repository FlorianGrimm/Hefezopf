...
namespace Hefezopf.SharePoint.Application.Administration
{
    ...
    public partial class DatabaseSettingsPage : BaseAdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SPUtility.TransferToErrorPage(HttpContext.GetGlobalResourceObject("Hefezopf.SharePoint.Application.ServiceAdminResources", "ErrorNoServiceApplication", CultureInfo.CurrentCulture).ToString());
            }
        ...
        protected void ButtonOk_Click(object sender, EventArgs e)
        {
            ...
            {
                operation.LeadingHTML = HttpContext.GetGlobalResourceObject("Hefezopf.SharePoint.Application.ServiceAdminResources", "DatabaseSettingsCreateOperationLeadingHtml", CultureInfo.CurrentCulture).ToString();
                operation.TrailingHTML = HttpContext.GetGlobalResourceObject("Hefezopf.SharePoint.Application.ServiceAdminResources", "DatabaseSettingsCreateOperationTrailingHtml", CultureInfo.CurrentCulture).ToString();
                operation.Begin();
