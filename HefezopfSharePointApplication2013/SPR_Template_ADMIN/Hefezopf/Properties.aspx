...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Properties.aspx.cs" Inherits="Hefezopf.SharePoint.Application.Administration.PropertiesPage" MasterPageFile="~/_layouts/15/dialog.master" %>
<asp:Content ID="contentDialogHeaderPageTitle" ContentPlaceHolderID="PlaceHolderDialogHeaderPageTitle" runat="server">
    <asp:Literal ID="literalDialogHeaderPageTitle" runat="server" Text='<%$ Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, PropertiesPageTitle %>'></asp:Literal>
</asp:Content>
<asp:Content ID="contentDialogDescription" ContentPlaceHolderID="PlaceHolderDialogDescription" runat="server">
    <asp:Literal id="literalDialogDescription" runat="server" Text='<%$ Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, PropertiesPageDescription %>' Mode="PassThrough" />
</asp:Content>
...
<asp:Content ID="contentDialogBodyMainSection" ContentPlaceHolderID="PlaceHolderDialogBodyMainSection" runat="server">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="ms-propertysheet">
            <wssuc:InputFormSection runat="server" Title="<%$Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, EditServiceNameSectionTitle%>" Description="<%$Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, EditServiceNameSectionDescription%>">
                <Template_InputFormControls>
                    <wssuc:InputFormControl runat="server" LabelText="<%$ Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, EditServiceNameLabel %>" >
                        <Template_Control>
                            <asp:TextBox runat="server" ID="textBoxServiceName" MaxLength="50" Width="300px" />
    			            <asp:RequiredFieldValidator ID="requiredFieldValidatorServiceName" runat="server" ControlToValidate="textBoxServiceName" Font-Bold="true" Forecolor="Red" Text="*" Display="Dynamic" ErrorMessage="<%$ Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, EditServiceNameRequiredError %>"></asp:RequiredFieldValidator>
                            <asp:CustomValidator ID="customValidatorServiceNameDuplicate" runat="server" ControlToValidate="textBoxServiceName" OnServerValidate="CustomValidatorServiceNameDuplicate_ServerValidate" Font-Bold="true" Forecolor="Red" Text="*" Display="Dynamic" ErrorMessage="<%$ Resources: Hefezopf.SharePoint.Application.ServiceAdminResources, EditServiceNameDuplicateError %>"></asp:CustomValidator>
                        </Template_Control>
