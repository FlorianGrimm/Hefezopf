    ...
    public class AstBuilder
    {
        ...
        public virtual void VerifyLanguageData()
        {
            ...
            foreach (var term in terms)
            {
                ...
                {
                    config.NodeType = this.GetDefaultNodeType(term);
                }
                ...
                {
                    config.DefaultNodeCreator = this.CompileDefaultNodeCreator(config.NodeType);
                }
            }
            if (missingList.Count > 0)
            {
                ...
                this.Context.AddMessage(ErrorLevel.Error, SourceLocation.Empty, Resources.ErrNodeTypeNotSetOn, string.Join(", ", missingList));
            }
