...
namespace Irony.Parsing
{
    ...
    public class WikiTextTerminal : WikiTerminalBase
    {
        ...
        public WikiTextTerminal(string name)
            : base(name, WikiTermType.Text, string.Empty, string.Empty, string.Empty)
        {
        ...
        public override void Init(GrammarData grammarData)
        {
            ...
            this._stopChars = stopCharSet.ToArray();
        }
        ...
        {
            bool isEscape = source.PreviewChar == this.EscapeChar && this.EscapeChar != NoEscape;
            if (isEscape)
            {
            ...
            var stopIndex = source.Text.IndexOfAny(this._stopChars, source.Location.Position + 1);
